...
@Component
public class MpesaCircuitBreakerProcessor implements Processor {
    ...
    public MpesaCircuitBreakerProcessor(@Qualifier("mpesaCircuitBreaker") CircuitBreaker circuitBreaker,
