...
public class PartnerDataCircuitBreakerProcessor implements Processor {
    private final CircuitBreaker circuitBreaker;
    private final CashInLogService cashInLogService;
    private final DepositService depositService;
    private final ServiceNameComponent serviceName;

    public PartnerDataCircuitBreakerProcessor(@Qualifier("partnerDataCircuitBreaker") CircuitBreaker circuitBreaker,
    ...
    private String getServiceName(ServiceNameComponent serviceName) {
        return switch (serviceName.getServiceName()) {
            ...
            case GEPG_PAYMENT -> "GEPG Payment";
            case VAT_PAYMENT -> "VAT Payment";
            case TRA_TAX_PAYMENT  -> "TRA tax Payment";
            case BANK_PAYMENT -> "Bank Payment";
            case VENDOR_SETTLEMENT -> "VendorDetails Settlement";
            case PARTNER_DATA_QUERY -> "Partner Data Query";
            default -> null;
        };
    }
}
