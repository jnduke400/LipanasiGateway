...
@Component
public class MixxCircuitBreakerProcessor implements Processor {
    ...
    public MixxCircuitBreakerProcessor(@Qualifier("mixxCircuitBreaker") CircuitBreaker circuitBreaker,
