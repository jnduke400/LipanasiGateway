...
@Component
public class AirtelCircuitBreakerProcessor implements Processor {
    ...
    public AirtelCircuitBreakerProcessor(@Qualifier("airtelCircuitBreaker") CircuitBreaker circuitBreaker,
