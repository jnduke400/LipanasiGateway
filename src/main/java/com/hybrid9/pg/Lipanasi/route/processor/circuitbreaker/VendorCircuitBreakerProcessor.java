...
@Component
public class VendorCircuitBreakerProcessor implements Processor {
    private final CircuitBreaker circuitBreaker;
    private final CashInLogService cashInLogService;
    private final DepositService depositService;
    private final ServiceNameComponent serviceName;

    public VendorCircuitBreakerProcessor(@Qualifier("vendorCircuitBreaker") CircuitBreaker circuitBreaker,
